import 'package:agm/screens/careerPages/pilotRoadMap.dart';
import 'package:flutter/material.dart';
import 'package:flutter_staggered_animations/flutter_staggered_animations.dart';

class PilotPath extends StatefulWidget {
  static const route = '/Pilot-path';

  @override
  _PilotPathState createState() => _PilotPathState();
}

class _PilotPathState extends State<PilotPath>
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                onTap: () {
                  Navigator.of(context).pushNamed(CommercialRoadMap.route);
                },
                child: Container(
